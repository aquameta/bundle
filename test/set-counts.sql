    ...
    for rel in (
        ...
        select * from (
            values
                ...
                ('commit_fields()',         'delta.commit_fields(delta.head_commit_id(''io.pgdelta.set_counts''))'),
                ...
                ('db_head_commit_rows()',   'delta.db_head_commit_rows(delta.repository_id(''io.pgdelta.set_counts''))'),
--                ('db_head_commit_fields', 'delta.db_head_commit_fields(delta.repository_id(''io.pgdelta.set_counts''))'),
                ...
                ('offstage_row_deleted()',  'delta.offstage_row_deleted(delta.repository_id(''io.pgdelta.set_counts''))')
                -- ('offstage_field_TODO',  'delta.offstage_row_deleted(delta.repository_id(''io.pgdelta.set_counts''))')
        )
    )
    loop
